...
#define TUYA_P2P_SDK_SKILL_NUMBER (TUYA_P2P_SDK_SKILL_BASIC | TUYA_P2P_SDK_SKILL_UDP_TCP_RELAY | TUYA_P2P_SDK_SKILL_PRECONNECT | TUYA_P2P_SDK_SKILL_MULTIMEDIA | TUYA_P2P_SDK_SKILL_IPV6)
...
//#define TUYA_UV_CLOSE(h, f) do { if (!tuya_uv_is_closing((tuya_uv_handle_t *)(h))) { tuya_uv_close((tuya_uv_handle_t *)(h), f); } } while(0)
